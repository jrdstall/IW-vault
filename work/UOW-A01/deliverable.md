<!--
unit: UOW-A01
summary: "Every core mechanic (integrated head/tail lights, ambient auto-dimming, brake-light-on-decel, magnetic dock charging) already ships in Livall and Lumos helmets; rear car-detection has been attempted by Classon via radar/camera with mixed market success — the concept is a solid remix target, not a novel build."
verdict: proceed
scores:
  novel: 2
  works: 4
